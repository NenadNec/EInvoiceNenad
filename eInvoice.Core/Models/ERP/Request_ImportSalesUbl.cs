...
{
    public class Request_ImportSalesUbl : AuditableModel
    {
        ...
        public string Napomena { get; set; }                                              // public string NapomeneNaFakturi { get; set; } //Invoice/cbc:Note
        ...
        public string BrojNarudzbenice { get; set; }
         public List<DebitNote_ReferencaFakture> ReferencaNaPrethodnuFakturu { get; set; }
        public string BrojOtpremnice { get; set; }
        public string BrojOkvirnogSporazuma { get; set; }
        public string BrojUgovora { get; set; }
        //public string IdentifikatorObjektaFakturisanja { get; set; } //Invoice/cac:AdditionalDocumentReference/cbc:ID 
        public List<ImporSalesUbl_EmbadedDocumentModel> PrilozeniPDF { get; set; } //cac:Invoice/AdditionalDocumentReference/Attachment/EmbeddedDocumentBinaryObject PDF kao Base64 string 
        ...
        public List<TaxSubtotal> PoreskiMeduzbir { get; set; } //Invoice/cac:TaxTotal/cbc:TaxSubtotal
        public LegalMonetaryTotal Sumarno { get; set; } //Invoice/cac:TaxTotal/cbc:TaxSubtotal
        public List<InvoiceLine> StavkeFakture { get; set; } //Invoice/cac:TaxTotal/cbc:TaxSubtotal
