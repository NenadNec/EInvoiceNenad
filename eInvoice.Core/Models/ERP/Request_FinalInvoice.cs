...
{
    public class Reques_FinalInvoice : AuditableModel
    {
        ...
        public List<FinaInvoice_ReferencaFakture> ReferencaNaPrethodnuFakturu { get; set; }
        ...
        public List<ImporSalesUbl_EmbadedDocumentModel> PrilozeniPDF { get; set; }
        ...
        public List<FinaInvoice_TaxSubtotal> PoreskiMeduzbir { get; set; } //Invoice/cac:TaxTotal/cbc:TaxSubtotal
        public List<FinaInvoice_TaxSubtotalAvans> PoreskiMeduzbirAvans { get; set; }
        public decimal SmanjeniUkupanIznosPDVKodAvansneFakture { get; set; }
        public List<FinaInvoice_TaxSubtotalAvansReduced> PoreskiMeduzbirAvansReduced { get; set; }
        public FinalInvoice_MonetaryTotal Sumarno { get; set; } //Invoice/cac:TaxTotal/cbc:TaxSubtotal
        public FinalInvoice_MonetaryTotalAvans SumarnoAvans { get; set; }
        public List<FinalInvoice_InvoiceLine> StavkeFakture { get; set; } //Invoice/cac:TaxTotal/cbc:TaxSubtotal
